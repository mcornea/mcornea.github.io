...
<a href="{{'/public/images/routing-lab-New-Page.png' | prepend: site.baseurl | prepend: site.url }}"><img src="{{'/public/images/routing-lab-New-Page.png' | prepend: site.baseurl | prepend: site.url }}" alt="ospf routing lab logical" width="821" height="729" class="aligncenter size-full wp-image-260" /></a>
...
<a href="{{'/public/images/routing-physical-New-Page.png' | prepend: site.baseurl | prepend: site.url }}"><img src="{{'/public/images/routing-physical-New-Page.png' | prepend: site.baseurl | prepend: site.url }}" alt="routing lab physical" width="745" height="625" class="aligncenter size-full wp-image-259" /></a>
