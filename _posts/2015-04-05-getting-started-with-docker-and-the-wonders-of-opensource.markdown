...
<a href="{{'/public/images/Containers-start-New-Page1.png' | prepend: site.baseurl | prepend: site.url }}"><img src="{{'/public/images/Containers-start-New-Page1.png' | prepend: site.baseurl | prepend: site.url }}" alt="Containers start - New Page" width="1167" height="657" class="aligncenter size-full wp-image-303" /></a>
...
<a href="{{'/public/images/Screenshot-from-2015-04-05-212408.png' | prepend: site.baseurl | prepend: site.url }}"><img src="{{'/public/images/Screenshot-from-2015-04-05-212408.png' | prepend: site.baseurl | prepend: site.url }}" alt="Screenshot from 2015-04-05 21:24:08" width="1430" height="847" class="aligncenter size-full wp-image-304" /></a>
